    ...
    */
    ...
    "operations" => array(
        ...
        "getRecurringApplicationCharges" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2021-07/recurring_application_charges.json",
        ...
        "getRecurringApplicationCharge" => array(
            "httpMethod" => "GET",
            "uri" => "/admin/api/2021-07/recurring_application_charges/{id}.json",
        ...
        "activateRecurringApplicationCharge" => array(
            "httpMethod" => "POST",
            "uri" => "/admin/api/2021-07/recurring_application_charges/{id}/activate.json",
